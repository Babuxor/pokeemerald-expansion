const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] = //Massima lunghezza = 12 caratteri
{
    ...
    [MOVE_SUBMISSION] = _("Sottomiss."), //Nome Completo: Sottomissione
    [MOVE_LOW_KICK] = _("Colpo Basso"),
    [MOVE_COUNTER] = _("Contrattacco"),
    [MOVE_SEISMIC_TOSS] = _("Mov. Sismico"), //Nome Completo: Movimento Sismico
    [MOVE_STRENGTH] = _("Forza"),
    [MOVE_ABSORB] = _("Assorbimento"),
    [MOVE_MEGA_DRAIN] = _("Megassorbim."), //Nome Completo: Megassorbimento
    [MOVE_LEECH_SEED] = _("Parassiseme"),
    [MOVE_GROWTH] = _("Parassiseme"),
    ...
    [MOVE_QUICK_ATTACK] = _("Att. Rapido"), //Nome Completo: Attacco Rapido
    [MOVE_RAGE] = _("Ira"),
    [MOVE_TELEPORT] = _("Teletraspor."), //Nome Completo: Teletrasporto
    [MOVE_NIGHT_SHADE] = _("Ombra Nott."), //Nome Completo: Ombra Notturna
    [MOVE_MIMIC] = _("Mimica"),
    ...
    [MOVE_SELF_DESTRUCT] = _("Autodistruz."), //Nome Completo: Autodistruzione
    ...
    [MOVE_GLARE] = _("Sgua. Feroce"), //Nome Completo: Bagliore (Gen I-V), Sguardo Feroce (Gen VI-)
    [MOVE_DREAM_EATER] = _("Mangiasogni"),
    [MOVE_POISON_GAS] = _("Velenogas"),
    [MOVE_BARRAGE] = _("Att. Pioggia"), //Nome Completo: Attacco Pioggia
    [MOVE_LEECH_LIFE] = _("Sanguisuga"),
    [MOVE_LOVELY_KISS] = _("Demonbacio"),
    [MOVE_SKY_ATTACK] = _("Aeroattacco"),
    [MOVE_TRANSFORM] = _("Trasformaz."), //Nome Completo: Trasformazione
    [MOVE_BUBBLE] = _("Bolla"),
    ...
    [MOVE_DESTINY_BOND] = _("Destinobbl."), //Nome Completo: Destinobbligato
    ...
    [MOVE_GIGA_DRAIN] = _("Gigassorbim."), //Nome Completo: Gigassorbimento
    ...
    [MOVE_DYNAMIC_PUNCH] = _("Magnitudo"),
    ...
    [MOVE_HIDDEN_POWER] = _("Lucelunare"),
    ...
    [MOVE_FAKE_OUT] = _("Fake Out"), //Gen 3
